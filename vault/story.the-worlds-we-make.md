...
Einen Hinweis auf ihre frühere Funktion liefern die [[Präparate|material.somsoplast-plastic-animal-models]] selbst. Die Art der Zurichtung deutet darauf hin, dass es sich nicht um Objekte einer _Forschungs_-sammlung wie der des Naturkundemuseums handelt, sondern um [[_Lehr_-objekte|story.history-of-the-zoological-teaching-collection]]. Zum einen wurden Präparate für die universitäre Lehre buchstäblich zugeschnitten oder bestanden aus [[isolierten Körperteilen|story.bobby-tracking-body-parts2]], um verschiedene Funktionen oder Organe eines Tieres zu demonstrieren. In diesem Fall sind bei manchen der Tiere bestimmte Körperpartien wie etwa das Nervensystem freigelegt.
