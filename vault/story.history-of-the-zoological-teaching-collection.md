...
This [[discontinuity|story.untraceable]] has inscribed itself into the corpus of the historical collection as a caesura and void, for, in 1970, the section head made the decision to reduce the size of the teaching collection.[^21] Duplicates were donated, given or thrown away, and, according to anecdotes, were even buried in the rear courtyard of the former institute.[^22] This is still making it [[difficult|material.an-iguana-preserved-in-alcohol]] to identify specific specimens as (former) items from the teaching collection.
